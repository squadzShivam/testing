...
`;function Cm(e){const[t,n]=S.useState(null),[r,o]=S.useState(!1),[i,l]=S.useState(!1),[a,s]=S.useState(""),u=Et();S.useEffect(()=>{const x=async()=>{const m=await xe.get(`/user/${e.userId}`),p=m.data.fullname;n({name:p.length>=20?p.split(" ").map((v,g)=>g>0?`${v[0].toUpperCase()}.`:v).join(" "):p,picture:m.data.avatar?`http://65.1.147.11:4000/api/user/picture/${m.data.avatar}`:"/images/profile-pic.png"})},y=+e.uploadDate,E=(Date.now()-y)/1e3/60;if(E<=1)s("now");else{const m=E/60;if(m<1){const p=Math.round(m);s(p===0?"Just now":`${p} minute${p>1?"s":""} ago`)}else if(m<24){const p=Math.round(m);s(`${p} hour${p>1?"s":""} ago`)}else{const p=Math.round(m/24);s(`${p} day${p>1?"s":""} ago`)}}e.hideUserData||x().catch(m=>console.error(m))},[]);const d=()=>{u(`/video/${e.id}`)},f=()=>{o(!0)},h=()=>{l(!0)};return c.jsxs(c.Fragment,{children:[i&&c.jsx(ew,{onClose:()=>l(!1),videoId:e.id}),r&&c.jsx(gw,{onClose:()=>o(!1),videoId:e.id}),c.jsxs(tw,{children:[c.jsxs("div",{children:[e.length&&c.jsx("div",{className:"duration",children:e.length}),c.jsx("img",{src:`http://65.1.147.11:4000/api/video/cover/${e.coverImage}`,alt:""}),c.jsx("button",{className:"play",onClick:d,children:c.jsx(u5,{})})]}),t&&c.jsx(nw,{$image:t.picture,children:c.jsx("div",{})}),c.jsxs("div",{className:"misc",children:[t&&c.jsxs("div",{className:"user-name",children:[c.jsx("span",{children:t.name}),c.jsx("span",{className:"dot"})]}),c.jsx("h1",{id:"title",children:e.title}),a&&c.jsx("div",{className:"upload-date",children:a})]}),e.showControls&&c.jsxs(rw,{children:[c.jsx("button",{className:"edit",onClick:f,children:c.jsx(Bx,{})}),c.jsx("button",{className:"delete",onClick:h,children:c.jsx(Ax,{})})]})]})]})}const ow=A.div`
  width: 100%;
  height: 100%;
  cursor: pointer;
  display: flex;
...
`;function np(e){const t=+e,r=(Date.now()-t)/1e3/60;if(r<=1)return"now";{const o=r/60;if(o<1){const i=Math.round(o);return i===0?"Just now":`${i} minute${i>1?"s":""} ago`}else if(o<24){const i=Math.round(o);return`${i} hour${i>1?"s":""} ago`}else{const i=Math.round(o/24);return`${i} day${i>1?"s":""} ago`}}}function Kw(){const{id:e}=r2(),t=Oc(e),n=Mc(t?`/video/a?user=${t.userId}`:"").videos,[r,o]=S.useState(screen.width>parseInt(H.screen.s)),[i,l]=S.useState(null),a=S.useRef(null),s=S.useRef(null),u=document.querySelector("#player-container"),d=S.useMemo(()=>t?np(t.uploadDate):"",[t]);return S.useEffect(()=>{const f=()=>{o(window.innerWidth>parseInt(H.screen.s))};return window.addEventListener("resize",f),()=>window.removeEventListener("resize",f)},[]),S.useEffect(()=>{if(!t)return;const f=s.current;return f&&f.load(),document.title=t.title,xe.get(`/user/${t.userId}`).then(h=>{const{fullname:x,avatar:y}=h.data;l({name:x,avatar:y?`http://65.1.147.11:4000/api/user/picture/${y}`:""})}).catch(h=>console.error(h)),()=>{document.title=`${t.title}| PB OTT`}},[t,e]),t?c.jsxs(c.Fragment,{children:[u&&!r&&Zr.createPortal(c.jsx(tp,{children:c.jsx("video",{autoPlay:!0,controls:!0,ref:s,children:c.jsx("source",{src:`http://65.1.147.11:4000/api/video/${t.id}`})})}),u),c.jsxs(qw,{ref:a,children:[c.jsxs("div",{children:[r&&c.jsx(tp,{children:c.jsx("video",{autoPlay:!0,controls:!0,ref:s,children:c.jsx("source",{src:`http://65.1.147.11:4000/api/video/${t.id}`})})}),c.jsx("h1",{children:t.title.length>64?t.title.slice(0,64)+"...":t.title}),c.jsx("div",{className:"upload-date",children:d}),i&&c.jsxs("div",{className:"user",children:[c.jsx(Qw,{$src:i.avatar?i.avatar:"/images/profile-pic.png",children:c.jsx("div",{})}),c.jsx("div",{className:"name",children:i.name})]})]}),n&&n.length>1&&c.jsxs("div",{children:[c.jsx("div",{className:"more",children:c.jsx("ul",{children:n.map((f,h)=>f.id!==e?c.jsx("li",{children:c.jsx(iw,{id:f.id,cover:`http://65.1.147.11:4000/api/video/cover/${f.coverImage}`,title:f.title,uploader:i?i.name:"",uploadDate:np(f.uploadDate)})},h):null)})}),c.jsxs("p",{children:[n.length-1," other video",n.length>2?"s":""," found ✨"]})]})]})]}):c.jsxs(Ww,{children:[c.jsx("span",{children:"Video not found"}),c.jsx(Em,{})]})}const Yw=ot`
from {
  transform: rotate(0);
} to {
  transform: rotate(360deg);
